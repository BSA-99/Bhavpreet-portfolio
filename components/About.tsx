  ...
  return (
    ...
    >
      <div className="glass relative mx-auto max-w-[1200px] overflow-hidden px-6 py-12 sm:px-10 lg:px-14 lg:py-16">
        ...
        <div className="relative z-[2] grid grid-cols-1 items-start gap-12 lg:grid-cols-[0.78fr_1.22fr] lg:gap-20">
          <div
            className="relative mx-auto aspect-[4/5] w-full max-w-[380px] overflow-hidden rounded-inner lg:mt-[0.4em] lg:max-w-none"
