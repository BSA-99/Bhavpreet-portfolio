      ...
      <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-12 lg:grid-cols-[0.78fr_1.22fr] lg:gap-20">
        <div className="glass glass-quiet relative mx-auto aspect-[4/5] w-full max-w-[380px] overflow-hidden lg:max-w-none">
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at 50% 38%, color-mix(in srgb, var(--color-accent) 22%, transparent) 0%, transparent 62%)",
            }}
          />
          <Image
        ...
        <div>
          <h2 className="mb-6 max-w-[24ch] font-display text-[26px] font-bold leading-[1.12] tracking-[-0.025em] sm:text-[34px] lg:text-[44px]">
            Fourth-year CS Co-op at StFX, graduating December 2026.
          </h2>

          <p className="mb-4 max-w-[62ch] font-body text-[15px] leading-[1.7] text-muted sm:text-base">
          ...
          <p className="mb-9 max-w-[62ch] font-body text-[15px] leading-[1.7] text-muted sm:text-base">
